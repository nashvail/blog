...
export default function Content() {
  return (
    <>
      ...
      <p>
        Since mornings are so precious to me I have taught myself to fall asleep
        early. It required baking in certain habits in the last few hours that
        lead to sleep. For example, no junk food, or coffee, or watching or
      ...
      <p>
        ...
        level with the front camera on.
      </p>

      <p>
        Hell I can even make it a 10 or 20 and it'll be true. I mean even you’re
        looking at a screen right now, and I am channeling my thoughts through
      ...
      <p>
        ...
        the phone the second you wake up. People don’t want to get bored
        anymore, it’s as if boredom bites them, scratches the insides of their
        skulls, puts a saliva soaked fingertip inside their ears, wets their
        socks, nibbles on their earlobes or licks the side of their faces.
      </p>
      <p>
      ...
      <p>
        ...
        Yes? That's exactly why you need to follow this.
      </p>
      <p>
